...
| Skill | Description |
|-------|-------------|
| [developer-growth-analysis](.github/skills/developer-growth-analysis/SKILL.md) | Analyzes your recent Claude Code chat history to identify coding patterns, development gaps, and ... \| This skill provides personalized feedback on your recent coding work by analyzing your Claude Cod... |
| [figma-automation](.github/skills/figma-automation/SKILL.md) | Automate Figma tasks via Rube MCP (Composio): files, components, design tokens, comments, exports. Always search tools fir... \| Automate Figma operations through Composio's Figma toolkit via Rube MCP. |
